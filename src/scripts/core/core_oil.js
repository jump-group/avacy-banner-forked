import { OilVersion, sendEventToHostSite, setGlobalOilObject, googleTagManagerEvents, tealiumTagManagerEvents, tagManagerEvents } from './core_utils';
...
export function getQueryStringParam(string) {
